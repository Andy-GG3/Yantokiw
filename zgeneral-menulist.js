...
│╰────────────────···
╰──────────═┅═──────────    
${readMore}\n╭━━━━━━━━┈─◂\n│≡ *TAG LIST*\n┴\n│${global.htjava} .menulist  ${daftarTag}\n╰━━━━━━━━┈─◂\n*Total Tag:${Object.keys(tagCount).length}*`, contextInfo: { externalAdReply: { showAdAttribution: true, title: wm, body: author, mediaType: 1, thumbnail: fs.readFileSync(prn), sourceUrl: 'https://andyy.com', renderLargerThumbnail: true } } }, { quoted: m, ephemeralExpiration: global.ephemeral });
  await conn.sendFile(m.chat, './mp3/old2.mp3', '', null, m, true) 
    ...
    conn.sendMessage(m.chat, { document: fs.readFileSync("./package.json"),
      ...
      pageCount: 10909143,  
      caption:  `╭━━━━━━━━┈─◂\n│≡ *${perintah}*\n├━━━━━━━━┈─◂\n│\n│${global.pmenus}${daftarHelp}\n╰━━━━━━━━┈─◂\n\n*Total Item:${tagHelpMapping[perintah].length}*`, contextInfo: { externalAdReply: { title: wm, body: author, mediaType: 1, thumbnail: fs.readFileSync('./1.jpg'), sourceUrl: 'https://Javanese', renderLargerThumbnail: true } } }, { quoted: m, ephemeralExpiration: global.ephemeral });
  ...
  │ ʙᴇʀɪ ᴊᴇᴅᴀ ʏᴀʜ ᴋᴀᴋ ^ω^
  ╰━━━━━━━━━━┈─◂
${readMore}\n╭━━━━━━━━┈─◂\n│≡ *TAG LIST AND HELP*\n╰━━━━━━━━┈─◂\n\n${allTagsAndHelp}\n\n*Total Tags:${Object.keys(tagCount).length}*`, contextInfo: { externalAdReply: { title: wm, body: author, mediaType: 1, thumbnail: fs.readFileSync('./1.jpg'), sourceUrl: 'https://Javanese', renderLargerThumbnail: true } } }, { quoted: m, ephemeralExpiration: global.ephemeral });
  } else {
